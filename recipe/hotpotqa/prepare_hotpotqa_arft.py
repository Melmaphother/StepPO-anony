...
def _cross_eval_row_to_arft(
    ex: dict[str, Any],
    data_source: str,
    split: str,
    row_index: int,
) -> dict[str, Any]:
    """Convert one cross-eval QA example to the HotpotQA ARFT row schema.
...
def _write_cross_eval_parquets(
    ...
    """Write cross-eval validation parquets in HotpotQA ARFT schema.
    ...
    for config_name in configs:
        ...
        rows = [
            _cross_eval_row_to_arft(dataset[i], config_name, split, i)
